...
const   Approach =()=> {
  return (
      ...
      <div className="py-20 flex flex-col lg:flex-row items-center justify-center bg-white dark:bg-transparent w-full gap-4 mx-auto px-8">
              <Card title="Project Overview" icon={<AceternityIcon order='Phase 1'/>}
                     description=" Project goals, Key aspects and Success metrics "

              >
          <CanvasRevealEffect
            animationSpeed={5.1}
           containerClassName="bg-emarald-900"
          />
        </Card>
              <Card title="Design and Development" icon={<AceternityIcon order={"Phase 2"}/>}
                                    description=" Initial study, Prototyping methods and Workflow tools  "
>
          <CanvasRevealEffect
            animationSpeed={3}
                      containerClassName="bg-emarald-900"
          ...
          <div className="absolute inset-0 [mask-image:radial-gradient(400px_at_center,white,transparent)] bg-black/50 dark:bg-black/90" />
              ...
              <Card title=" Testing and Deployment " icon={<AceternityIcon order="Phase 3" />}
                  description=" User testing, Iteration and Maintenance "              
    >
          <CanvasRevealEffect
            animationSpeed={3}
            containerClassName="bg-emarald-900"
