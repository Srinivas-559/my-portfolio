...
import { Button } from './ui/MovinBorder'
...
const Experience = () => {
  return (
    ...
    <div className='mt-12 w-full grid  lg:grid-cols-4 md:grid-cols-1 gap-10'>
                  ...
                  >
                      ...
                      <div className='flex lg:flex-row flex-col lg:items-center p-3 py-6 md:p-5 lg:p-10 gap-2  ' >
                          ...
                          <div className='lg:ms-5'>
                              ...
                              <p className='text-start text-white-100 mt-3 font-semibold'>{ card.graduationYear}</p>
                          </div>
                      </div>
                  </Button>
